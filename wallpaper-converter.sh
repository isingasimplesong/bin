...
input_dir="/home/mathieu/Images/walls"
output_dir="/home/mathieu/Images/walls_converted"
...
find "$input_dir" -type f \( -iname "*.png" -o -iname "*.webp" -o -iname "*.jpg" -o -iname "*.jpeg" \) | while read file
do
